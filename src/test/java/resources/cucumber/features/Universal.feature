...
#Feature: AirportInfo Controller test
  ...
  #Scenario: AirportInfo finds closest airport of the user
    ...
    #Then user gets info about the nearest Airport

  #Scenario: AirportInfo adds new airport to the DB
    #Given user connects to the FreeFlight/Nearest
    #Then AirportInfo should add which airport has been shown in FreeFlight/Nearest
